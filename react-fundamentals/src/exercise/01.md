...
Learned how node manipulation works better. When you want to add or remove dom
elements you actually have to think more structurally as method usage depends on
other nodes (f.e. rootElement.append(otherNode)).
