...
It makes sense why you can't use statements in jsx as jsx is just syntactical
sugar for react function calls and children are React.createElement arguments
and you can't put statements inside arguments. Also jsx interpolation works on
the same principal which is also seen in other programming languages.
