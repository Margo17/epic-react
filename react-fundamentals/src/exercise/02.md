...
Interesting part was that you can pass children as a third argument or as a part
of prop argument. And if you pass a child array it can throw no key prop error
just like listing items in jsx, which makes sense.
